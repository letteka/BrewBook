...
class RecipeTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    @IBAction func insertNewObject(sender: AnyObject) {
        ...
        newManagedObject.setValue("New Item", forKey: "name")
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "recipeDetailSegue" {
            if let indexPath = self.tableView.indexPathForSelectedRow() {
                ...
                (segue.destinationViewController as! RecipeDetailViewController).detailItem = object
            }
        }
    }
    ...
    var fetchedResultsController: NSFetchedResultsController {
        ...
        let aFetchedResultsController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: self.managedObjectContext!, sectionNameKeyPath: nil, cacheName: "RecipeTableView")
